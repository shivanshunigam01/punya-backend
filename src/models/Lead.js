...
const LeadSchema = new mongoose.Schema(
  {
    ...
    status: {
      type: String,
      enum: ["new", "contacted", "qualified", "converted", "lost", "C0", "C1", "C2", "C3"],
      default: "new",
      index: true,
    },
    ...
    utm_medium: String,
    utm_campaign: String,
    compared_product_ids: [{ type: mongoose.Schema.Types.ObjectId, ref: "Product" }],
    compared_product_names: [{ type: String }],
    is_strong_lead: { type: Boolean, default: false, index: true },
    cibil_checked: { type: Boolean, default: false, index: true },
    cibil_score: Number,
    cibil_score_band: String,
    client_meta: {
      ip: String,
      userAgent: String,
      referrer: String,
