...
// Admin
r.post("/", requireAuth, requireRole(["master_admin"]), createTestimonial);
r.put("/:id", requireAuth, requireRole(["master_admin"]), updateTestimonial);
r.delete("/:id", requireAuth, requireRole(["master_admin"]), deleteTestimonial);
