...
const schema = Joi.object({
  ...
  customer_title_hi: Joi.string().allow("", null),
  customer_photo: Joi.string().uri().allow("", null),
  rating: Joi.number().integer().min(1).max(5).required(),
  review_text: Joi.string().required(),
  review_text_hi: Joi.string().allow("", null),
  product_purchased: Joi.string().allow("", null),
  product_purchased_hi: Joi.string().allow("", null),
  badge_text: Joi.string().allow("", null),
  badge_text_hi: Joi.string().allow("", null),
